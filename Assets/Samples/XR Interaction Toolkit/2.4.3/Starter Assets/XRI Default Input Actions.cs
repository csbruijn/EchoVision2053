...
public partial class @XRIDefaultInputActions: IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""SendEcho"",
                    ""type"": ""Button"",
                    ""id"": ""84c74747-4148-4d9a-8f13-a8a80d81831d"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""9d98a30a-6f34-4347-8c5b-8787d958851e"",
                ...
                {
                    ""name"": """",
                    ""id"": ""54683c94-3ddb-4f68-9a9f-b0ab6aa505f9"",
                    ""path"": ""<Mouse>/press"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_XRIRightHand_SendEcho = m_XRIRightHand.FindAction("SendEcho", throwIfNotFound: true);
    ...
    private readonly InputAction m_XRIRightHand_SendEcho;
    public struct XRIRightHandActions
    {
        ...
        public InputAction @SendEcho => m_Wrapper.m_XRIRightHand_SendEcho;
        ...
        public void AddCallbacks(IXRIRightHandActions instance)
        {
            ...
            @PokeRotation.performed += instance.OnPokeRotation;
            @PokeRotation.canceled += instance.OnPokeRotation;
            @SendEcho.started += instance.OnSendEcho;
            @SendEcho.performed += instance.OnSendEcho;
            @SendEcho.canceled += instance.OnSendEcho;
        }
    ...
    public interface IXRIRightHandActions
    {
        ...
        void OnPokePosition(InputAction.CallbackContext context);
        void OnPokeRotation(InputAction.CallbackContext context);
        void OnSendEcho(InputAction.CallbackContext context);
    }
